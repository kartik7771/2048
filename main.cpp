...
bool canDoMove(int line, int coloumn, int nextLine, int NextColoumn)
{
    if(nextLine<0 || NextColoumn<0 || nextLine>=4 || NextColoumn>=4 ||
       board[line][coloumn]!=board[nextLine][NextColoumn] && board[nextLine][NextColoumn]!=0)
        return false;
